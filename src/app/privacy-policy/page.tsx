...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-white font-sans">
      <section className="bg-primary-light py-24 md:py-28">
        <div className="container-fox text-center">
          <span className="mb-5 block text-[10px] font-black uppercase tracking-[0.35em] text-accent">
            Website & Lead Form Privacy
          </span>
          ...
          <p className="mx-auto max-w-3xl text-lg leading-relaxed text-gray-300">
            How Vishome Carpet handles inquiry details, website data, cookies, and third-party services for B2B
