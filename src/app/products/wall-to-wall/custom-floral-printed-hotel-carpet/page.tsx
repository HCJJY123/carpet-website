...
const faqs = [
  ...
  ["Can VCARPETS produce my own carpet pattern?", "Yes. Buyers can provide artwork, interior renderings, color references or an existing design concept. VCARPETS will review the pattern repeat, direction, scale and color requirements before confirming production."],
...
export const metadata: Metadata = {
  title: "Custom Printed Carpet | Floral Hotel Broadloom | VCARPETS",
...
export default function CustomFloralPrintedHotelCarpetPage() {
  ...
  const productJsonLd = {
    ...
    brand: { "@type": "Brand", name: "VCARPETS" }, category: "Wall-to-Wall Carpet",
    ...
    offers: { "@type": "AggregateOffer", url: absoluteUrl(path), priceCurrency: "USD", lowPrice: "3.60", highPrice: "6.40", offerCount: 1, availability: "https://schema.org/PreOrder", itemCondition: "https://schema.org/NewCondition", seller: { "@type": "Organization", name: "VCARPETS" } },
  };
      ...
      <section className="border-b border-border bg-slate-50 py-16 md:py-24">
        <div className="container-fox grid items-start gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="space-y-8 py-2">
            <div><p className="mb-4 text-[10px] font-black uppercase tracking-[0.3em] text-accent">VCARPETS Custom Printed Broadloom</p>
            ...
            <InquiryActions />
            <p className="text-sm leading-relaxed text-muted">Send your project area, required quantity, destination country, application area, preferred material and pattern reference. VCARPETS will confirm the suitable specification, artwork process, price and production schedule.</p>
          </div>
        </div>
      </section>
