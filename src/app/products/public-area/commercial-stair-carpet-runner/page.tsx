...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Commercial Stair Carpet Runner | VCARPETS",
...
const faqs = [
  ...
  { q: "Who confirms stair safety and code compliance?", a: "The project designer and local installer must confirm nosing, tread geometry, fixing method, slip resistance, fire requirements, and local code compliance. VCARPETS supplies product information for the selected construction." },
  ...
  return (
    <ApplicationProductPage
      ...
      overview={[
        ...
        "VCARPETS can review natural sisal, synthetic sisal-look, and selected contract carpet options. Final dimensions and installation details should be signed off by the local installer before cutting and binding begins.",
      ]}
      applications={[
