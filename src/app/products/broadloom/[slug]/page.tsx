    ...
    <>
      <section className="bg-surface border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <Link href="/products/broadloom" className="text-sm text-accent hover:text-accent-light mb-4 inline-flex items-center gap-1">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Back to Broadloom
          </Link>
          <div className="grid md:grid-cols-2 gap-8 mt-4">
            <div className="bg-gradient-to-br from-accent/10 to-accent/5 rounded-2xl p-8 flex items-center justify-center min-h-[300px]">
              <div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: "Roll Size", value: product.spec.size },
