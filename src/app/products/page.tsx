...
export const metadata: Metadata = {
  title: "Commercial Carpet Products | VCARPETS",
  description: "Explore VCARPETS commercial carpet products including modular carpet tiles, wall-to-wall hotel broadloom, and heavy-duty public area carpet systems for global B2B projects.",
  alternates: { canonical: "/products" },
};
export default function ProductsPage() {
  const jsonLd = collectionItemListJsonLd({
    name: "VCARPETS Commercial Carpet Products",
