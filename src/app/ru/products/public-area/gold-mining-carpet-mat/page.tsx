...
export const metadata: Metadata = product
  ? {
      ...
      keywords: [
        "коврик для золотодобычи",
        "коврик для промывки золота",
        "miners moss",
        "коврик для шлюза",
        "шлюзовой коврик",
        "оборудование для золотодобычи Казахстан",
        "коврик для старательской добычи",
        "промывочный коврик для золота Алматы",
      ],
      alternates: {
