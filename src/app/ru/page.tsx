...
export const metadata: Metadata = {
  title: "Коммерческие и гостиничные ковровые покрытия из Китая | VCARPETS",
  description:
    "Ковровая плитка, гостиничный и коммерческий ковролин, а также коврики для золотодобычи от фабрики VCARPETS. Поставки в Казахстан, Узбекистан и страны СНГ.",
  alternates: {
  ...
  openGraph: {
    title: "Коммерческие ковровые покрытия из Китая | VCARPETS",
