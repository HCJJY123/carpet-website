...
const rootOnlyRoutes = [
  ...
  { url: "/llms.txt", modified: "2026-08-20", priority: 0.2, changeFrequency: "weekly" as const },
  { url: "/llms-full.txt", modified: "2026-08-20", priority: 0.2, changeFrequency: "weekly" as const },
  { url: "/ai-sources.json", modified: "2026-08-20", priority: 0.2, changeFrequency: "weekly" as const },
