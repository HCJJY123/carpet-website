...
export const products: Product[] = [

  {
    ...
    longDescription: "VCARPETS Luxury Hotel Carpet Tile 50x50cm is a modular commercial carpet tile solution for hotel carpet floor renovation, office carpet projects, corridors, lobbies, meeting rooms, and global B2B flooring buyers. The tile carpet format supports easy installation, selective replacement, color coordination, and project-scale supply for contractors, distributors, hotels, offices, and commercial renovation teams.",
    image: "/images/products/luxury-hotel-carpet-tile-50x50cm/01-main-carpet-tile-top-view.webp",
    imageAlt: "VCARPETS luxury hotel carpet tile 50x50cm commercial nylon carpet tiles for office and hotel carpet floor projects",
    gallery: [
      { src: "/images/products/luxury-hotel-carpet-tile-50x50cm/01-main-carpet-tile-top-view.webp", alt: "Top view of VCARPETS 50x50cm commercial carpet tiles for hotel carpet floor and office carpet projects" },
      ...
      { src: "/images/products/luxury-hotel-carpet-tile-50x50cm/05-color-range-swatches.webp", alt: "Color range swatches for VCARPETS tile decor carpet and office carpet projects" },
  ...
  },
  {
    ...
    name: "VCARPETS EcoCore PVC-Free PE Backing Carpet Tiles",
    category: "carpet-tiles",
    ...
    longDescription: "VCARPETS EcoCore PE Backing Carpet Tiles are developed for B2B flooring projects where sustainability, modular flexibility, and commercial durability need to work together. The product combines a dense textured loop pile surface with a stable PVC-free PE backing structure, creating a practical flooring solution for office buildings, coworking spaces, education facilities, public workspaces, and LEED-oriented green building interiors.",
    image: "/images/products/ecocore-pe-backing/01-hero-white-background.webp",
    imageAlt: "VCARPETS EcoCore PVC-free PE backing 50x50cm commercial carpet tile for sustainable office flooring",
    moq: "Project-Based",
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/products/50x50-nylon-pp-office-carpet-tiles/10-factory-qc.webp", alt: "Factory quality control for VCARPETS commercial carpet tiles and floor carpets" }
    ],
    moq: "200 SQM",
  ...
  },
  {
    ...
    name: "VCARPETS Gray Line Nylon Carpet Tiles for Office and Hotel Carpet Floors",
    category: "carpet-tiles",
    ...
    longDescription: "VCARPETS Gray Line Nylon Carpet Tiles are designed for buyers sourcing durable, modern carpet tiles for office carpet, hotel carpet floor, meeting room, corridor, and commercial carpet projects. The gray textured tile carpet design uses subtle yellow-green line accents to create a clean architectural floor effect, while the modular tile carpet floor format supports fast installation, flexible layout direction, and easy replacement for large commercial interiors.",
    image: "/images/products/gray-line-nylon-office-carpet-tiles/01-office-workspace-carpet-tiles.webp",
    imageAlt: "VCARPETS gray line nylon carpet tiles installed in modern office carpet and hotel carpet floor project",
    gallery: [
  ...
  },
  {
    ...
    longDescription: "VCARPETS Premium Nylon 6.6 Commercial Carpet Tiles combine Class 33 traffic performance, bitumen backing, stain resistance, and modular replacement for high-use office and contract interiors.",
    image: "/images/carpet-tile-premium.webp",
    imageAlt: "Premium Nylon 6.6 commercial carpet tiles for high-traffic office corridors by VCARPETS",
    moq: "200 SQM",
    moqTiers: { sample: "Material Swatch Available", trialOrder: "100 SQM Standard Color", project: "200 SQM" },
    leadTime: "10-14 Days",
  ...
  },
  {
    ...
    longDescription: "VCARPETS Axminster wool-blend broadloom is a custom woven hotel carpet for premium contract interiors, with project-specific jacquard patterns, roll planning, and export supply.",
  ...
  },
  {
    ...
    longDescription: "VCARPETS's 3D HD Printed Nylon Hotel Carpet is a wall-to-wall broadloom flooring solution engineered for hospitality interiors. Using high-definition digital printing on a durable 100% nylon surface, it reproduces intricate, photo-realistic patterns and rich color depth that conventional dyed carpets cannot match - at a lower setup cost and faster lead time than woven Axminster or Wilton broadloom.",
    ...
    gallery: [
      { src: "/images/3d-printed-hotel-carpet-roll.webp", alt: "Wall-to-wall printed hotel broadloom carpet roll, 4m width, VCARPETS" },
      ...
      { src: "/images/3d-printed-hotel-carpet.webp", alt: "3D HD printed nylon hotel carpet swatch with elegant gold and burgundy pattern by VCARPETS" },
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/products/3d-printed-banquet-carpet/04-corridor-detail.webp", alt: "Hotel corridor wall-to-wall carpet with 3D printed blue and gold wave pattern by VCARPETS" }
    ],
    moq: "200 SQM",
  ...
  },
  {
    ...
    longDescription: "VCARPETS's Glitter Hotel Corridor Broadloom Carpet is a custom wall-to-wall hotel carpet designed for memorable hospitality interiors. The deep navy field, gold glitter effect, and flowing corridor pattern help hotels create a premium arrival path while supporting commercial project requirements such as high-traffic durability, dimensional stability, stain resistance options, and custom roll production.",
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/products/wall-to-wall/custom-polyester-loop-casino-carpet/06-source-factory-global-supply-rolls.webp", alt: "VCARPETS source factory global supply rolls for custom casino carpet projects" },
      ...
      { src: "/images/products/wall-to-wall/custom-polyester-loop-casino-carpet/12-source-factory-carpet-roll-supply.webp", alt: "VCARPETS source factory carpet roll supply for casino carpet projects" }
    ],
    moq: "300 SQM",
  ...
  },
  {
    ...
    longDescription: "VCARPETS Custom Floral Printed Wall-to-Wall Hotel Carpet is a project-based patterned broadloom program with adjustable artwork, colorways, material options, and pile height for hospitality and commercial interiors.",
  ...
  },
  {
    ...
    imageAlt: "VCARPETS gold mining carpet mat PVC miners moss for sluice box gold recovery",
    gallery: [
  ...
  },
  {
    ...
    longDescription: "VCARPETS's Natural Sisal Linen-Weave Commercial Carpet is a 100% plant-fiber flooring crafted from durable agave sisalana sisal, woven into a refined linen-look flatweave.",
    image: "/images/natural-sisal-carpet-office.webp",
    imageAlt: "Natural sisal linen-weave commercial carpet installed in office reception public area by VCARPETS",
    moq: "300 SQM",
  ...
  },
  {
    ...
    longDescription: "VCARPETS Commercial Stair Carpet Runner is a made-to-size program for stair treads, risers, landings, and adjoining circulation areas. Natural sisal, sisal-look synthetic, and project-selected contract constructions can be reviewed according to traffic, cleaning, edge binding, underlay, nosing, fire-performance, and slip-resistance requirements. Final installation details and code compliance remain the responsibility of the project designer and local installer.",
...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    metadataTitle: "Exhibition & Expo Booth Carpet Specification Guide | VCARPETS",
  ...
  },
  {
    ...
    metadataTitle: "Gold Mining Sluice Carpet Field Specification Guide | VCARPETS",
  ...
  },
  {
    ...
    metadataTitle: "Event Hall & Ballroom Carpet Planning - Romania | VCARPETS",
    ...
    sections: [
      ...
      },
      {
        title: "Why VCARPETS",
        paragraphs: [
          "VCARPETS can support CAD pattern matching, fire-document review and seam planning for large hospitality floors. That makes the quotation more useful for the buyer, because the scope covers both appearance and installation logic instead of only a carpet price."
        ]
      }
    ],
    technicalDetails: [
  ...
  },
  {
    ...
    metadataTitle: "Sisal & Natural Fiber Rug Wholesale Sourcing Guide | VCARPETS",
