...
export const countryMarketPages: CountryMarketPage[] = [
  commercialPage({
    ...
    metadataTitle: "Commercial Hotel Carpet Supplier UAE | VCARPETS",
    ...
    directAnswer: "A commercial hotel carpet supplier for the UAE should help the project team compare guestroom, corridor, lobby and ballroom constructions by traffic, pattern approval, backing, maintenance, fire and VOC documentation, and delivery plan. VCARPETS supports project enquiries from Dubai, Abu Dhabi and other UAE destinations with hotel broadloom and commercial carpet options; final specifications, documents and shipping terms require project confirmation.",
  ...
  commercialPage({
    market: "uk",
    slug: "education-carpet-tile-supplier",
    language: "en",
    hreflang: "en-GB",
    openGraphLocale: "en_GB",
    countryName: "United Kingdom",
    countryNameLocal: "United Kingdom",
    title: "Education Carpet Tile Supplier for UK Schools and Universities",
    metadataTitle: "Education Carpet Tile Supplier UK | VCARPETS",
    metadataDescription: "Education carpet tiles for UK schools and universities. Compare classrooms, libraries, corridors and student areas by traffic, documents, phased installation and spare stock.",
    updatedDate: "2026-09-10",
    directAnswer: "UK school and university carpet tile buyers should compare each education zone by traffic, rolling furniture, cleaning, fire and VOC document requirements, installation window and replacement plan. VCARPETS supports project enquiries for education carpet tile sourcing, while final construction, project acceptance and delivery terms require written confirmation.",
    marketContext: "UK education projects often coordinate design, estates, facilities, contractor and term-time access requirements. A useful RFQ separates classrooms, libraries, corridors, student centres and staff areas instead of pricing the whole campus as one identical zone.",
    environmentNote: "Education flooring planning should account for occupied buildings, wet entrance soil, frequent cleaning, rolling chairs or trolleys, acoustic preferences and the practical limits of holiday or low-occupancy installation windows.",
    deliveryNote: "For a UK destination, request the final carton or pallet plan, gross weight, delivery city, site access window, unloading assumptions and any phased handover requirement. This page does not represent a UK warehouse, local stock or a guaranteed delivery route.",
    applications: ["Classrooms and teaching rooms", "Libraries and study areas", "Main corridors and entrances", "Student centres and faculty offices"],
    localTerms: ["education carpet tile supplier UK", "school carpet tiles UK", "university carpet tiles UK", "education flooring procurement UK", "commercial carpet tiles for schools"],
    heroImage: "/images/blog-series/uk-school-university-carpet-tile-procurement-guide/uk-school-university-carpet-tile-hero.webp",
    heroImageAlt: "Education carpet tile procurement desk with samples and project planning documents",
    supportingImages: [
      {
        ...
        title: "Traffic-zone planning",
        description: "Separate classrooms, libraries, corridors, student centres and staff areas before comparing fiber, backing, cleaning and replacement assumptions.",
      },
      {
        ...
        title: "Maintenance and replacement review",
        description: "Connect cleaning, local replacement and spare-stock decisions to the education project schedule and zone requirements.",
      },
      {
        ...
        title: "Spare stock and phased handover",
        description: "Confirm labelled spare cartons, storage conditions, delivery sequence and phased handover responsibilities before ordering.",
      },
    ],
    localIntentSections: [
      {
        title: "UK school and university project trigger",
        summary: "The strongest purchase intent usually names the education building, zone, programme and documentation need rather than asking for a generic carpet price.",
        points: [
          "State whether the project is a school, university, campus residence, library, student centre, refurbishment or new fit-out.",
          "Separate classrooms, corridors, libraries, offices and common areas because traffic, cleaning and replacement access can differ.",
          "Name the UK delivery city, expected installation window and whether work must fit a holiday or low-occupancy programme.",
        ],
      },
      {
        title: "Education approval and installation checks",
        summary: "Education buyers normally need the physical sample, project documents and site assumptions to remain aligned through approval.",
        points: [
          "Request the exact fiber, pile, tile size, backing, thickness and available fire or low-emission documents for the quoted construction.",
          "Confirm concrete or raised-access flooring, moisture and flatness checks, adhesive recommendation, old flooring removal and storage conditions.",
          "Record sample approval, pattern direction, batch or dye-lot assumptions, cleaning method, spare cartons and phased handover responsibilities.",
        ],
      },
      {
        title: "Search wording UK buyers use",
        summary: "These phrases distinguish project procurement intent from retail carpet searches.",
        points: [
          "education carpet tile supplier UK — for schools, colleges and universities comparing project suppliers.",
          "school carpet tiles UK — for classroom, corridor, library and common-area replacement planning.",
          "university carpet tiles UK — for campus, student-centre and phased refurbishment requirements.",
        ],
      },
      {
        title: "What to include in a UK education RFQ",
        summary: "A complete RFQ lets a supplier quote the right construction and delivery basis without inventing site assumptions.",
        points: [
          "Building type, UK city, zone schedule, square metres by area, furniture or caster use and target handover date.",
          "Fiber, backing, tile format, pattern direction, acoustic preference, cleaning route and required technical documents.",
          "Sample deadline, installation window, spare-stock quantity, carton or pallet plan, unloading route and delivery contact.",
        ],
      },
    ],
    productSet: "office",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Philippines | VCARPETS",
    ...
    directAnswer: "A commercial carpet supplier for the Philippines should help buyers compare moisture-tolerant backing, heavy-traffic performance, sample approval, installation conditions and consolidated delivery. VCARPETS supplies carpet tiles, hotel broadloom and public-area carpet for project inquiries, with final specifications confirmed against the site environment and tender requirements.",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Australia | VCARPETS",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Bulgaria | VCARPETS",
    ...
    directAnswer: "A commercial carpet supplier for Bulgaria should help project buyers compare office carpet tiles, hospitality broadloom, backing options, spare stock, sample approval and export packing before order confirmation. VCARPETS supports Bulgaria project inquiries from China, while final suitability must be checked against the buyer's tender, local contractor and installation conditions.",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Canada | VCARPETS",
    ...
    directAnswer: "A commercial carpet supplier for Canada should help buyers plan moisture, snow and salt exposure, chair-wheel wear, phased renovation, spare stock and technical document review before the quotation is approved. VCARPETS can support carpet tile and hospitality carpet sourcing from China, but the final construction must match the building specification and local installation conditions.",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Romania | VCARPETS",
    ...
    directAnswer: "A commercial carpet supplier for Romania should help buyers compare chair-wheel wear, phased replacement, TDS review, sample approval and freight planning before the order is placed. VCARPETS supplies project-based carpet tiles, hotel broadloom and public-area carpet from China, while the final specification must still be checked against the tender and site conditions.",
  ...
  commercialPage({
    ...
    metadataTitle: "Dostawca wykładzin komercyjnych Polska | VCARPETS",
    ...
    directAnswer: "Dostawca wykładzin komercyjnych dla Polski powinien umożliwić porównanie konstrukcji włókna, podkładu, klasy użytkowej, dokumentów projektowych i sposobu wymiany zużytych stref. VCARPETS przygotowuje próbki i wyceny projektowe, natomiast końcową zgodność należy potwierdzić z wymaganiami inwestora i lokalnymi przepisami.",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Poland | VCARPETS",
    ...
    directAnswer: "A commercial carpet supplier for Poland should help buyers evaluate fiber construction, backing, traffic class, maintenance needs and project documents before a quotation is approved. VCARPETS can prepare project options for offices, hotels and public interiors, but the nominated specification must still be checked by the buyer or consultant.",
  ...
  commercialPage({
    ...
    metadataTitle: "Furnizor mochetă comercială România | VCARPETS",
    ...
    directAnswer: "Un furnizor de mochetă comercială pentru România trebuie evaluat după material, suport, trafic, întreținere, mostre și documentația solicitată de proiect. VCARPETS poate pregăti opțiuni pentru birouri, hoteluri și zone publice, iar specificația finală se confirmă înaintea comenzii.",
  ...
  commercialPage({
    ...
    metadataTitle: "Proveedor de alfombras comerciales México | VCARPETS",
    ...
    directAnswer: "Un proveedor de alfombras comerciales para México debe confirmar uso, tráfico, soporte, mantenimiento, muestra aprobada y condiciones de instalación antes de producir. VCARPETS suministra losetas modulares, alfombra hotelera y soluciones para áreas públicas con cotización basada en el proyecto.",
  ...
  commercialPage({
    ...
    metadataTitle: "Leverandør af erhvervstæpper Danmark | VCARPETS",
    ...
    directAnswer: "En leverandør af erhvervstæpper til Danmark bør kunne dokumentere konstruktion, slidklasse, akustiske egenskaber, vedligeholdelse og prøveproces. VCARPETS tilbyder projektbaseret sourcing, men alle dokumentkrav og den endelige gulvopbygning skal godkendes til det konkrete projekt.",
  ...
  commercialPage({
    ...
    metadataTitle: "Tijorat gilam yetkazib beruvchi O‘zbekiston | VCARPETS",
    ...
    directAnswer: "O‘zbekistondagi tijorat gilam loyihasi uchun mahsulot turi, trafik darajasi, asos materiali, namuna tasdig‘i va yetkazib berish rejasi birgalikda tekshirilishi kerak. VCARPETS loyiha talabi bo‘yicha gilam plitka va mehmonxona gilamini taklif qiladi.",
  ...
  commercialPage({
    ...
    metadataTitle: "Առևտրային գորգերի մատակարար Հայաստան | VCARPETS",
    ...
    directAnswer: "Հայաստանում առևտրային գորգ ընտրելիս պետք է համեմատել նյութը, հիմքը, ծանրաբեռնվածությունը, սպասարկումը, նմուշը և առաքման պայմանները։ VCARPETS-ը տրամադրում է նախագծային առաջարկներ, իսկ վերջնական բնութագիրը հաստատվում է կոնկրետ օբյեկտի պահանջներով։",
  ...
  commercialPage({
    ...
    metadataTitle: "Dobavljač komercijalnih tepiha Hrvatska | VCARPETS",
    ...
    directAnswer: "Dobavljač komercijalnih tepiha za Hrvatsku treba potvrditi namjenu prostora, intenzitet prometa, podlogu, održavanje, uzorak i uvjete ugradnje. VCARPETS priprema projektne opcije za hotele, urede i javne prostore, uz konačnu provjeru specifikacije prije narudžbe.",
  ...
  commercialPage({
    ...
    metadataTitle: "Kereskedelmi szőnyeg beszállító Magyarország | VCARPETS",
    ...
    directAnswer: "Magyarországi kereskedelmi szőnyegprojektnél a használati osztályt, anyagot, hátoldalt, karbantartást, mintát és beépítési feltételeket együtt kell értékelni. A VCARPETS projektalapú ajánlatot készít, a végleges megfelelőséget pedig a konkrét kiírás alapján kell ellenőrizni.",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Czech Republic | VCARPETS",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Hungary | VCARPETS",
  ...
  commercialPage({
    ...
    metadataTitle: "Коммерческий ковролин Кыргызстан | VCARPETS",
    ...
    directAnswer: "Для проекта в Кыргызстане коммерческий ковролин следует выбирать по назначению, нагрузке, основе, обслуживанию, образцу и условиям монтажа. VCARPETS готовит проектный расчет, а окончательные параметры подтверждаются после проверки требований объекта.",
  ...
  commercialPage({
    ...
    metadataTitle: "Коммерциялық кілем жеткізуші Қазақстан | VCARPETS",
    ...
    directAnswer: "Қазақстандағы коммерциялық кілем жобасында материал, негіз, қозғалыс жүктемесі, үлгі, қызмет көрсету және жеткізу кезеңдері бірге тексерілуі керек. VCARPETS жоба бойынша ұсыныс береді, ал соңғы сипаттама нысан талаптарына сай расталады.",
  ...
  commercialPage({
    ...
    metadataTitle: "Dobavljač komercijalnih tepiha Srbija | VCARPETS",
    ...
    directAnswer: "Za komercijalni tepih u Srbiji kupci treba da provere namenu, opterećenje, vlakno, podlogu, održavanje, uzorak i uslove ugradnje. VCARPETS priprema projektne opcije, dok se konačna specifikacija potvrđuje prema zahtevima objekta.",
  ...
  commercialPage({
    ...
    metadataTitle: "Leverandør kommersielle tepper Norge | VCARPETS",
    ...
    directAnswer: "En leverandør av kommersielle tepper til Norge bør kunne beskrive fiber, bakside, bruksklasse, akustikk, vedlikehold og dokumentasjon uten å anta at én løsning passer alle bygg. VCARPETS tilbyr prosjektbaserte alternativer som må kontrolleres mot den aktuelle beskrivelsen.",
  ...
  commercialPage({
    ...
    metadataTitle: "Dodavatel komerčních koberců Česko | VCARPETS",
    ...
    directAnswer: "Dodavatel komerčních koberců pro český projekt by měl doložit konstrukci, zátěž, podklad, údržbu, vzorky a požadované dokumenty. VCARPETS připravuje projektové varianty, které je nutné před objednávkou porovnat s konkrétní specifikací.",
  ...
  commercialPage({
    ...
    metadataTitle: "Dodávateľ komerčných kobercov Slovensko | VCARPETS",
    metadataDescription: "Kobercové štvorce a hotelové koberce pre slovenské projekty. Vzorky, parametre, MOQ a projektová ponuka.",
    directAnswer: "Pri komerčnom koberci na Slovensku treba porovnať materiál, podklad, záťaž, údržbu, vzorku a podmienky montáže. VCARPETS pripravuje projektové možnosti, pričom konečná špecifikácia sa potvrdzuje podľa požiadaviek konkrétnej stavby.",
  ...
  commercialPage({
    ...
    metadataTitle: "Dobavitelj poslovnih preprog Slovenija | VCARPETS",
    ...
    directAnswer: "Pri izbiri poslovne preproge v Sloveniji je treba preveriti uporabo, obremenitev, vlakno, podlago, vzdrževanje, vzorec in pogoje vgradnje. VCARPETS pripravi projektne možnosti, končna specifikacija pa se potrdi glede na zahteve objekta.",
  ...
  commercialPage({
    ...
    metadataTitle: "Commercial Carpet Supplier Singapore | VCARPETS",
    ...
    directAnswer: "Singapore commercial carpet projects should evaluate traffic, backing, fire-document requirements, maintenance access, indoor humidity and replacement strategy before approval. VCARPETS supplies project carpet options with samples and specification records, while final compliance must be confirmed for the nominated building and installation system.",
  ...
  commercialPage({
    ...
    metadataTitle: "Singapore Casino Carpet Supplier | Oriental Flower Carpet | VCARPETS",
  ...
  commercialPage({
    ...
    metadataTitle: "კომერციული ხალიჩის მომწოდებელი საქართველო | VCARPETS",
    ...
    directAnswer: "საქართველოში კომერციული ხალიჩის არჩევისას საჭიროა გამოყენების, დატვირთვის, საფუძვლის, მოვლის, ნიმუშისა და მონტაჟის პირობების ერთად შეფასება. VCARPETS ამზადებს პროექტულ ვარიანტებს, ხოლო საბოლოო სპეციფიკაცია ობიექტის მოთხოვნებით დასტურდება.",
  ...
  commercialPage({
    ...
    metadataTitle: "Leverantör kommersiella mattor Sverige | VCARPETS",
    ...
    directAnswer: "En leverantör av kommersiella mattor till Sverige bör kunna redovisa material, baksida, belastning, akustik, underhåll och dokumentation. VCARPETS erbjuder projektbaserade alternativ, men slutlig produkt och dokumentation måste kontrolleras mot den aktuella kravspecifikationen.",
  ...
  commercialPage({
    ...
    metadataTitle: "Коммерческий ковролин Беларусь | VCARPETS",
    ...
    directAnswer: "Для проектов в Беларуси коммерческий ковролин нужно сравнивать по назначению, нагрузке, основе, обслуживанию, образцу и монтажной системе. VCARPETS готовит проектные предложения, а доступность маршрута, оплаты и документов подтверждается отдельно для каждого заказа.",
  ...
  commercialPage({
    ...
    metadataTitle: "Kaupallisten mattojen toimittaja Suomi | VCARPETS",
    ...
    directAnswer: "Suomen kaupallisissa mattoprojekteissa tulee vertailla materiaalia, taustarakennetta, käyttöluokkaa, akustiikkaa, huoltoa ja asiakirjoja. VCARPETS tarjoaa projektikohtaisia vaihtoehtoja, jotka on tarkistettava kohteen lopullista määrittelyä vasten.",
  ...
  commercialPage({
    ...
    metadataTitle: "Kommersiya xalça təchizatçısı Azərbaycan | VCARPETS",
    ...
    directAnswer: "Azərbaycanda kommersiya xalçası seçərkən istifadə sahəsi, trafik, əsas, qulluq, nümunə və quraşdırma şərtləri birlikdə qiymətləndirilməlidir. VCARPETS layihə üzrə variantlar hazırlayır, yekun xüsusiyyətlər isə obyekt tələblərinə əsasən təsdiqlənir.",
  ...
  goldPage({
    ...
    metadataTitle: "Alfombra para minería de oro Perú | VCARPETS",
  ...
  goldPage({
    ...
    metadataTitle: "Alfombra para minería de oro Colombia | VCARPETS",
