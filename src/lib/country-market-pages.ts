...
export const countryMarketPages: CountryMarketPage[] = [
  ...
  commercialPage({
    ...
    metadataTitle: "Education Carpet Tile Supplier UK | VISHOME",
    ...
    heroImage: "/images/case-wework.webp",
    heroImageAlt: "Illustrative modular carpet tile education interior for UK school and university procurement planning",
    supportingImages: [
      {
        src: "/images/products/50x50-nylon-pp-office-carpet-tiles/05-modern-office-application.webp",
        alt: "Illustrative modular carpet tile application for education and commercial interiors",
        title: "Zone planning before quotation",
      ...
      {
        src: "/images/products/50x50-nylon-pp-office-carpet-tiles/10-factory-qc.webp",
        alt: "Illustrative carpet tile quality review for an education procurement package",
        title: "Sample and document review",
        description: "Review the physical sample, exact construction, technical documents, packing and spare-stock plan as one education project package.",
      },
    ],
    localIntentSections: [
      {
