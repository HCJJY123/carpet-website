...
export const caseProductRelations: Record<string, string[]> = {
  ...
  "case-3": ["cinema-theater-carpet", "3d-printed-hotel-carpet", "3d-printed-banquet-hall-carpet"],
  "case-4": ["healthcare-hospital-carpet-tiles", "public-area-heavy-duty", "ecocore-pe-backing-carpet-tiles"],
  ...
  "case-7": ["commercial-stair-carpet-runner", "custom-luxury-hotel-room-carpet", "custom-floral-printed-hotel-carpet"],
  "case-8": ["education-school-carpet-tiles", "commercial-nylon-tiles", "ecocore-pe-backing-carpet-tiles"],
  ...
  "case-13": ["3d-printed-banquet-hall-carpet", "glitter-hotel-corridor-broadloom-carpet", "luxury-hotel-broadloom"],
  "case-14": ["natural-sisal-carpet", "custom-sculpted-wool-lobby-rug", "commercial-stair-carpet-runner"],
};
