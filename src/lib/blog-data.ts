...
export const blogPosts: BlogPost[] = [
  ...
  sluiceMattingGuide,
  {
    ...
    seoTitle: "Hotel Acoustic Carpet Specification Guide | VCARPETS",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "paragraph",
            text: "VCARPETS can compare multiple backing constructions against the same design, provide documentation for the quoted build, and prepare project quantities with full commercial documentation. Guests will never see the test reports, but they will experience the result.",
          },
          {
            type: "callout",
            label: "Next step",
  ...
  },
  {
    ...
    seoTitle: "Premium Carpet Tiles Maintenance Cost Guide | VCARPETS",
  ...
  },
  {
    ...
    seoTitle: "Axminster vs Wilton vs Tufted Hospitality Guide | VCARPETS",
  ...
  },
  {
    ...
    seoTitle: "Carpet Printing Technology Guide | VCARPETS",
  ...
  },
  {
    ...
    seoTitle: "High-Traffic Carpet Tile Specification Guide | VCARPETS",
  ...
  },
  {
    ...
    seoTitle: "Hidden Cost of Cheap Hospitality Carpets | VCARPETS",
  ...
  },
  {
    ...
    seoTitle: "Commercial Carpet Installation Climate Control Guide | VCARPETS",
