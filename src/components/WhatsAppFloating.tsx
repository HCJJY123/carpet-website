...
export default function WhatsAppFloating() {
  ...
  return (
    <div className="group fixed right-4 top-[54vh] z-[98] md:right-6 md:top-[52vh]">
      ...
      <a
        ...
        className="relative flex h-12 w-[154px] items-center gap-2 rounded-lg bg-white px-2.5 text-[#168a42] shadow-[0_8px_22px_rgba(16,42,67,0.16)] ring-1 ring-[#25D366]/25 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_10px_26px_rgba(37,211,102,0.24)] md:h-14 md:w-[176px] md:gap-3 md:px-3"
        aria-label="Contact VISHOME on WhatsApp Business"
      >
        <span className="relative flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white shadow-sm md:h-9 md:w-9">
          <svg
            viewBox="0 0 24 24"
            width="18"
            height="18"
        ...
        <span className="notranslate min-w-0 flex-1 whitespace-nowrap text-[10px] font-black uppercase leading-none tracking-[0.08em] md:text-[11px]" translate="no">
          WhatsApp
        </span>
      </a>
    </div>
