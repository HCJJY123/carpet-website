...
export default function WhatsAppFloating() {
  ...
  return (
    <div className="fixed bottom-6 right-5 md:bottom-8 md:right-8 z-[100] flex flex-col items-end gap-3 group">
      <div className="pointer-events-none max-w-[220px] rounded-2xl bg-[#102A43] px-4 py-3 text-right text-white shadow-2xl opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
      ...
      <a
        ...
        className="relative flex h-[74px] w-[74px] items-center justify-center rounded-[24px] bg-white shadow-[0_18px_45px_rgba(16,42,67,0.22)] ring-1 ring-[#25D366]/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_22px_55px_rgba(37,211,102,0.34)]"
        aria-label="Contact VISHOME on WhatsApp Business"
      >
        <span className="absolute -right-1 -top-1 rounded-full bg-[#102A43] px-2 py-1 text-[8px] font-black uppercase tracking-wider text-white shadow-lg">
          Business
        </span>
        <span className="absolute inset-2 rounded-[20px] bg-[#25D366]/12" />
        ...
        <span className="absolute inset-0 rounded-[24px] bg-[#25D366] opacity-10 animate-ping" />
      </a>
    </div>
  );
}
