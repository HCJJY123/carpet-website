      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/products/carpet-tiles" className="text-sm text-gray-300 hover:text-white transition-colors">
                  Carpet Tiles
                </Link>
              </li>
              <li>
                <Link href="/products/broadloom" className="text-sm text-gray-300 hover:text-white transition-colors">
                  Broadloom Carpets
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link href="/cases" className="text-sm text-gray-300 hover:text-white transition-colors">
                  Case Studies
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-gray-300">
              ...
              <li className="pt-2">
                <Link
                  href="/contact"
                  className="inline-block bg-accent text-white text-sm font-medium px-5 py-2.5 rounded-lg hover:bg-accent-light transition-colors"
                >
                  Send Inquiry
                </Link>
              </li>
        ...
        <div className="border-t border-white/10 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} CarpetPro. All rights reserved.
          </p>
